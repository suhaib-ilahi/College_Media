...
const StackSection = () => {
  return (
 <section class="py-16 bg-bg-secondary border-y border-slate-100">
        <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8">
            <div class="text-left md:w-1/3">
                <h3 class="text-lg font-semibold text-text-primary mb-2">Built with Modern Tech</h3>
                <p class="text-sm text-text-muted">Scalable, secure, and developer-friendly architecture.</p>
            </div>
