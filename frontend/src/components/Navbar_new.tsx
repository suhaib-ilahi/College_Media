...
function Navbar({ searchQuery, setSearchQuery }) {
  return (
    <nav className="fixed top-0 left-64 right-0 z-50 bg-bg-secondary border-b border-border">
          ...
          <div className="flex-1 max-w-xl">
            <div className="relative">
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-gray-100 border border-border rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-300 transition-all duration-300 text-sm"
              />
