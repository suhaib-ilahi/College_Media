...
const RisingStudent = () => {
  return (
    <section className="py-8 bg-white dark:bg-slate-800 border-y border-slate-100 dark:border-slate-700">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="flex items-center gap-2 mb-6">
          ...
          />
          <h2 className="text-lg font-semibold tracking-tight text-slate-900 dark:text-white">Rising Students</h2>
        </div>
        <div className="flex overflow-x-auto gap-4 pb-4 snap-x snap-mandatory">
          
          <div className="min-w-[240px] md:min-w-[220px] lg:min-w-0 lg:flex-1 snap-center p-4 rounded-2xl border border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-700/50 hover:bg-white dark:hover:bg-slate-700 hover:border-slate-200 dark:hover:border-slate-600 hover:shadow-sm transition-all text-center">
            <div className="w-16 h-16 mx-auto rounded-full bg-gradient-to-br from-pink-300 via-purple-300 to-indigo-400 p-0.5 mb-3">
              <div className="w-full h-full rounded-full bg-white dark:bg-slate-800 border-2 border-transparent"></div>
            </div>
            <h3 className="text-sm font-semibold text-slate-900 dark:text-white">Alex Chen</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 mb-2">CS • Year 3</p>
          ...
          <div className="min-w-[240px] md:min-w-[220px] lg:min-w-0 lg:flex-1 snap-center p-4 rounded-2xl border border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-700/50 hover:bg-white dark:hover:bg-slate-700 hover:border-slate-200 dark:hover:border-slate-600 hover:shadow-sm transition-all text-center">
            ...
            <h3 className="text-sm font-semibold text-slate-900 dark:text-white">Sarah Miller</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 mb-2">Design • Year 4</p>
          ...
          <div className="min-w-[240px] md:min-w-[220px] lg:min-w-0 lg:flex-1 snap-center p-4 rounded-2xl border border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-700/50 hover:bg-white dark:hover:bg-slate-700 hover:border-slate-200 dark:hover:border-slate-600 hover:shadow-sm transition-all text-center">
            ...
            <h3 className="text-sm font-semibold text-slate-900 dark:text-white">David Kim</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 mb-2">MBA • Year 1</p>
       ...
       <div className="min-w-[240px] md:min-w-[220px] lg:min-w-0 lg:flex-1 snap-center p-4 rounded-2xl border border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-700/50 hover:bg-white dark:hover:bg-slate-700 hover:border-slate-200 dark:hover:border-slate-600 hover:shadow-sm transition-all text-center">
            ...
            <h3 className="text-sm font-semibold text-slate-900 dark:text-white">Priya Patel</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 mb-2">EE • Year 2</p>
